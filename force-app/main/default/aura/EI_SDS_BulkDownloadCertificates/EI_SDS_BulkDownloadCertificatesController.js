({
    ...
    checkboxSelect: function(component, event, helper) {
        ...
        console.log('Id => '+ checkvalue.get("v.text").Id);
        console.log('Deposit_Certificate_Link__c => '+ checkvalue.get("v.text").Deposit_Certificate_Link__c);
        console.log('Deposit_Certificate_Name__c => '+ checkvalue.get("v.text").Deposit_Certificate_Name__c);
        if(!Array.isArray(checkvalue)){
            if (checkvalue.get("v.value")) {
                selectedDeposits.push({Id: checkvalue.get("v.text").Id, 
                                       DPCLink: checkvalue.get("v.text").Deposit_Certificate_Link__c,
                                       DPCName: checkvalue.get("v.text").Deposit_Certificate_Name__c
                                      });
            }
        }else{
        ...
        for (var i = 0; i < allRecords.length; i++) {
            ...
            if (allRecords[i].isChecked) {
                selectedRecords.push({Id: allRecords[i].objDeposit.Id, 
                                       DPCLink: allRecords[i].objDeposit.Deposit_Certificate_Link__c,
                                       DPCName: allRecords[i].objDeposit.Deposit_Certificate_Name__c
                                      });
            }
        }
    ...
    downloadPackage : function(component, event, helper) {
        debugger;
        console.log('b4inst')
    ...
    handleSearch : function(component, event, helper){
        ...
        component.set("v.showDeposits",true);
        var action = component.get('c.getSearchDepositInformation');
        action.setParams({
