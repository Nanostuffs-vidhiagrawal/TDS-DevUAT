({
    doInit : function(component, event, helper) {
        ...
        action.setCallback(this, function(result){
            ...
            if (component.isValid() && state === "SUCCESS"){
                ...
                var i;
                var totalChangeoverAmt=0;
                var totalNoOfChangeoverTenants=0;
                ...
                for(i = 1; i<resResult.length; i++) {
                    ...
                    if(resResult[i].Depallobject.Istenantmoved__c){
                        ...
                        totalChangeoverAmt = totalChangeoverAmt+
                            parseFloat(resResult[i].Depallobject.Tenencychangeoveramount__c);
                        totalNoOfChangeoverTenants++;
                        if((resResult[i].Depallobject.Deposit_Holder__r.PersonEmail == undefined || resResult[i].Depallobject.Deposit_Holder__r.PersonEmail == '')
                           &&(resResult[i].Depallobject.Deposit_Holder__r.PersonMailingStreet == undefined || resResult[i].Depallobject.Deposit_Holder__r.PersonMailingStreet == '')
                           &&(resResult[i].Depallobject.Deposit_Holder__r.PersonMailingCity == undefined || resResult[i].Depallobject.Deposit_Holder__r.PersonMailingCity == '')
                           &&(resResult[i].Depallobject.Deposit_Holder__r.PersonMailingCountry == undefined || resResult[i].Depallobject.Deposit_Holder__r.PersonMailingCountry == '')
                           &&(resResult[i].Depallobject.Deposit_Holder__r.PersonMailingPostalCode == undefined || resResult[i].Depallobject.Deposit_Holder__r.PersonMailingPostalCode == '')){
                            
                            blankAllocationList.push(resResult[i].Depallobject);
                ...
                component.set("v.totalChangeoverAmt",totalChangeoverAmt);
                component.set("v.totalNoOfChangeoverTenants",totalNoOfChangeoverTenants);
    ...
    createdeposit:function(component, event, helper) {
        ...
        var totalNoOfChangeoverTenants = component.get("v.totalNoOfChangeoverTenants");
        ...
        /*if((newtenantsNo-(alltenants-selectedtenantids.length))<0 || newtenantsNo=="" || newtenantsNo==undefined || 
            newtenantsNo==null)*/
        if((newtenantsNo-(alltenants-totalNoOfChangeoverTenants))<0 || newtenantsNo=="" || newtenantsNo==undefined || 
            newtenantsNo==null)
        {
            //console.log('Tenants less');
            isValid = false;
        ...
        //alert(`newtenantsNo - ${newtenantsNo} , alltenants - ${newtenantsNo} , changeovertenants - ${changeovertenants}`);
        if(isValid)
        {
            if((parseInt(newtenantsNo)) == ((alltenants)-(changeovertenants)))
            {
                //alert('Equal tenants');
                component.set("v.nextWindow2",false);
            } else {
                component.set("v.nextWindow2",true);
                component.set("v.isCorrect",false);
                component.set("v.upperSection",false);
            }
        }
    },
    ...
    clickYes: function (component, event, helper) {
        ...
        var ys =  component.find("secondYes");
        var no =   component.find("secondNo");
        
        $A.util.removeClass(no, "highlightbutton");
        $A.util.addClass(ys, "highlightbutton");
    },
    ...
    clickNo: function (component, event, helper) {
        ...
        $A.util.addClass(no, "highlightbutton");
        $A.util.removeClass(ys, "highlightbutton");
    },
	...
	handleYes : function(component, event, helper) {
		component.set("v.isCorrect",true);
    ...
    handleNo : function(component, event, helper) {
        ...
        var action = component.get("c.rejectChangeOverbyagent");
            action.setParams({
            ...
            action.setCallback(this, function(response) {
                ...
                if(state == 'SUCCESS') {
                    ...
                    //alert('messageValue111111111 ' + messageValue);
                    //var depositId = component.get("v.deptenantlist[0].Depositobject.Id");
                    component.find("navService").navigate({
                        type: "comm__namedPage",
                        attributes: {
	...
	backOnly : function(component, event, helper) {
        component.set("v.upperSection",true);
        component.set("v.isCorrect",true);
        component.set("v.nextWindow2",false);
        component.set("v.registertenantbutton",true);
        component.set("v.registerTenant",false);
        component.set("v.alreadyregistertenant",false);
