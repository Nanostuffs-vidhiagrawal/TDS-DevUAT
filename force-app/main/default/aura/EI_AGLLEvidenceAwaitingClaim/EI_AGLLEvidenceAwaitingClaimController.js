({
    doInit : function(component, event, helper) {
        ...
        let currentURL = window.location.href;
        let AccessCode = currentURL.split("depositid=")[1];
        let depositid = AccessCode;
        //let isLeadTenant = helper.getUrlParams('leadTenant');
        
        component.set("v.depositid" ,depositid);
        component.set("v.isLead" , false);
        console.log("line 21" + depositid);
        var action = component.get("c.getClaimDetailsForAwaitingEvidence");
        ...
        action.setCallback(this, function(a) {
            ...
            console.log('Line 29 ',state);
            var errors = a.getError();
            console.log('Line 29 ',JSON.stringify(errors));
            if (state == "SUCCESS") {
                    console.log("line 17" + JSON.stringify(a.getReturnValue()));
                    component.set("v.ClaimsDetails",a.getReturnValue());
                    console.log(' Line 33 - ',JSON.stringify(a.getReturnValue()));
                ...
                console.log('Line 58 ',errormessage);
