({
    doInit: function(component, event, helper) {
        ...
        // Get Picklist Valu e from Schema
    ...
    clickCreate: function (component, event, helper) {
        ...
        var surname = component.find("surNameId").get("v.value");
        var email = component.find("emailID").get("v.value");
        //helper.checkEmailDuplicacy(component, email, firstname, surname);
        var isDuplicateEmail = component.get("v.isDuplicateEmail");
    //    console.log("duplicateEmailError => " + component.get("v.duplicateEmailError"));
   //     console.log('clickCreate isDuplicateEmail ' +isDuplicateEmail);
        
        var propertyId ='';
        if(component.get("v.fromViewLandlord")){
            propertyId= component.get("v.propertyRecId");
        }
        var isValid = true;
     ...
     //     console.log(component.get("v.OrgUser")+' isValid112 ',isValid);
       ...
       //      console.log('in IF');
        ...
        {
         //    console.log('isValid131',isValid+companyNamecheck+companyPhonecheck+' * '+companyPhoneCode);
       ...
       //       console.log('isValid145',isValid);
        }else if(!component.get("v.OrgUser")){
         //      console.log(' isValid147 ',isValid);
            component.set("v.yesNoError", false);}
       //  console.log('isValid1147',isValid);
       ...
       //    console.log('isValid160',isValid);
        ...
        if(isValid)
        {
            ...
            console.log('Landlord will be created successfullypropertyRecId '+propertyRecId);
            ...
            var action = component.get("c.savelandlord");
                ...
                action.setCallback(this, function (a) {
                    ...
                    if (state == "SUCCESS") {
                     ...
                     //   console.log(component.get("v.fromViewLandlord")+' formview resultId '+result);
                           // if(!component.get("v.fromViewLandlord")){
            ...
            console.log('lastName ',component.get("v.lastName")); */
             ...
             $('#maincon2', window.parent.document).get(0).scrollIntoView();
