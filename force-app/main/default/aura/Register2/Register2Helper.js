({
    findAddress:function (component,event,helper,SecondFind) {
        var Text = document.getElementById("searchBox2LL").value;
            ...
            if (http.readyState == 4 && http.status == 200) {
                ...
                if (response.Items.length == 1 && typeof(response.Items[0].Error) != "undefined") {
                    ...
                    if (response.Items.length == 0)
                        ...
                        var resultBox = document.getElementById("result2LL");
                        ...
                        var resultArea = document.getElementById("result2LL");
    ...
    selectAddress:function (component,event,helper,Key){
        var resultList = document.getElementById("result2LL");
    ...
    retrieveAddress:function (component,event,Key, Id){
                ...
                if (response.Items.length == 1 && typeof(response.Items[0].Error) != "undefined") {
                    ...
                    if (response.Items.length == 0)
                        showError("Sorry, there were no results");
                          ...
                          var resBox = document.getElementById("output2LL");
                          var fullAddress;
      ...
      */
              ...
              document.getElementById("output2LL").style.display = "block";
              document.getElementById("seperator2LL").style.display = "block";
            
              document.getElementById("manualAddress2LL").style.display = "none";
