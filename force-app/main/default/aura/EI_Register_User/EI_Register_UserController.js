  ...
  OrgUsers: function(component, event, helper) {
	...
	clickCreate: function(component, event, helper) {
       ...
       /* var street = component.get("v.Street");
        ...
        if(userTyp == 'Tenant'){
            console.log('phone22 '+phone+' '+telephone)
            if ( (phone == undefined || phone == "" || phone == null) && (telephone == undefined || telephone == "" || telephone == null)){
        ...
        console.log('valid street '+street);
          console.log('valid city '+city);
          console.log('valid postcode '+postcode);
          console.log('valid country '+country);
         console.log('valid county '+county);
		...
		if(isValid){
          //  alert('to create');
			...
			if (userTyp == "Tenant") {
				...
				console.log('component.get("v.TelePhone") '+component.get("v.TelePhone"));
