({
     ...
     doInitHelper: function(component, event,selPickListValue) {
       console.log('Helper +++');
    var action = component.get("c.getdepositstatus");
        action.setParams({
      ...
      if (state === "SUCCESS") {
        ...
        //component.set("v.depositeList", oRes);
          ...
          /*  for(var i=0;i<depositResponse.length; i++){
                ...
                console.log('::Result='+depositResponse[i].Deposit__r.LastModifiedDate);
                var today =  new Date(depositResponse[i].Deposit__r.LastModifiedDate);
			  ...
			  "July", "August", "September", "October", "November", "December"];
                ...
                depositResponse[i].Deposit__r.LastModifiedDate = date; 
              
                console.log('::Date='+ date);
                console.log('::DateNew='+  depositResponse[i].Deposit__r.LastModifiedDate);
		}*/
