({
  findAddress: function (component, event, helper, SecondFind) {
    ...
    var Text = document.getElementById("searchBox10").value;
      ...
      if (http.readyState == 4 && http.status == 200) {
        ...
        if (
          ...
          if (response.Items.length == 0)
            ...
            var resultBox = document.getElementById("result10");

            if (resultBox.childNodes.length > 0) {
              var selectBox = document.getElementById("mySelect10");
              selectBox.parentNode.removeChild(selectBox);
            }

            var resultArea = document.getElementById("result10");
            var list = document.createElement("select");
            list.id = "selectList";
            list.setAttribute("id", "mySelect10");
  ...
  selectAddress: function (component, event, helper, Key) {
    console.log("@@ Select1");
    var resultList = document.getElementById("result10");

    if (resultList.childNodes.length > 0) {
      var elem = document.getElementById("mySelect10");
      ...
      elem.addEventListener("change", function () {
        ...
        // console.log("102 ");
        var target = document.getElementById("mySelect10").value;
      ...
      if (http.readyState == 4 && http.status == 200) {
        ...
        if (
          ...
          if (response.Items.length == 0)
            ...
            var resBox = document.getElementById("output10");
            var fullAddress;
...
console.log('line-->262');
      ...
      */
            var vx = component.get("v.method1");
            // document.getElementById("output").style.display = "block";
            document.getElementById("seperator10").style.display = "block";
            document.getElementById("manualAddress10").style.display = "none";
