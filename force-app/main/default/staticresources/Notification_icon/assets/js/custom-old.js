...
function search_btn() {
	...
	$('.search-btn').on('click', function() {
		...
		if($(window).width() > 991) {
			$(this).siblings(searchInput).css({'width': '73%' , 
												'opacity': '1', 
												'transition': '0.6s',
												'border-bottom': '1px solid #D5D5D5'});
		} else {
			$(this).siblings(searchInput).css({'width': '95%' , 
												'opacity': '1', 
												'transition': '0.6s',
												'border-bottom': '1px solid #D5D5D5'});
		}
...
function banner_form_tab() {
    ...
    $('.other-info').click(function () {
        ...
        $(this).parents('.banner_form-expand__tab').siblings('.banner_form-expand__tab').show();
    });
    $(tabs).on('click', function () {
        ...
        $(this).parents('.banner_form-detail').siblings('.banner_form-detail').css('display', 'none');
    ...
    $('.other-close-tab').on('click', function () {
        ...
        $(this).parents('.banner_form-expand__tab').siblings('.banner_form-expand__tab').css('display', 'block');
    });
    ...
    $('.close-tab').on('click', function () {
        ...
        $('.banner_form-detail__heading').css('display', 'block');
        $(this).parents('.banner_form-detail').siblings('.banner_form-detail').css('display', 'block');
...
function org_scroll() {
    $('.account-detail').on('click', function() {
        $('html, body').animate({scrollTop: $('#account-detail').offset().top - 30}, 1000);
    });

    $('.Correspondence-email').on('click', function() {
        $('html, body').animate({scrollTop: $('#Correspondence-email').offset().top - 30}, 1000);
    });

    $('.payment-details').on('click', function() {
        $('html, body').animate({scrollTop: $('#payment-details').offset().top - 30}, 1000);
    });

    $('.prescribed-info').on('click', function() {
        $('html, body').animate({scrollTop: $('#prescribed-info').offset().top - 30}, 1000);
    });

    $('.additional-user').on('click', function() {
        $('html, body').animate({scrollTop: $('#additional-user').offset().top - 30}, 1000);
    });

    $('.account-type').on('click', function() {
        $('html, body').animate({scrollTop: $('#account-type').offset().top - 30}, 1000);
    });

    $('.close-account').on('click', function() {
        $('html, body').animate({scrollTop: $('#close-account').offset().top - 30}, 1000);
    });
}
    ...
    if ($(window).width() > 767) {
        $('.enable-section').on('click', function () {
            if ($(this).parents().hasClass('col-md-6')) {
                ...
                $(this).parents('.col-md-6').addClass('col-md-12').removeClass('col-md-6');
        ...
        $('.disable-section').on('click', function () {
            if ($(this).parents().hasClass('col-md-12')) {
                ...
                $(this).parents('.col-md-12').addClass('col-md-6').removeClass('col-md-12').find(".more-info").hide();
            }
        });
    }
}
...
function datePicker() {
    ...
    if($('.date-picker').length > 0) {
        ...
        $('#start_date_tanent01').datepicker();
    }
}
...
function loadFormStepwithNextPrev() {
    jQuery('.form-wizard-next-btn').click(function() {
        ...
        parentFieldset.find('.wizard-required, [required], [required = "required"]').each(function(e) {
...
function multi_step_form_dataPicker() {
    $('#t_start_date_picker').datepicker({
        todayHighlight: true,
        autoclose: true,
